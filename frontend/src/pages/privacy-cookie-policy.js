    ...
    <section className={`container mx-auto my-24`}>
      <div className={`${styles.post}`}>
        ...
        <p>
          ...
          fishingshirtsnow.com. For more information about Us, see “Our Details”
        ...
        <p>
          ...
          (“You,” or “Your”); in other words, where We determine the purposes
        ...
        <p>
          ...
          media platform, such as Facebook, Twitter, Tumblr, LinkedIn, YouTube,
          or Pinterest, We may collect the Personal Data that You make available
          to Us on that page including Your account ID or handle. We will comply
          with the privacy policies of the corresponding social media platform
          and We will only collect and store such Personal Data that We are
        ...
        <p>
          ...
          for the purpose of enabling them to contact You so that they can
          offer, market and sell relevant Goods and/or Services to You. Each
          such third party will act as a data controller in relation to the
          Enquiry Data that We supply to it; and upon contacting You, each such
          third party will supply to You a copy of its own privacy policy, which
          will govern that third party's use of Your Personal Data. The
          suppliers and providers with whom We may share Your information
          include:
        </p>
        <ul>
        ...
        <p>
          ...
          disclosures of Personal Data set out in this Section, We may disclose
          Your <strong>Personal Data</strong> where such disclosure is necessary
          for compliance with a legal obligation to which We are subject, or in
          order to protect Our vital interests, Your vital interests, or the
        ...
        <p>
          ...
          of data between your computer and fishingshirtsnow.com. The use of
          HTTPS makes sure your communication with us is:
        </p>
        <p>
          <strong>Encrypted</strong> — The data you exchange with us is secure
          from eavesdroppers. That means that when you are browsing
          fishingshirtsnow.com, nobody can track your activities across multiple
          pages, or steal the data exchange between your computer and
        ...
        <p>
          ...
          Us at support@fishingshirtsnow.com.
        </p>
        <p>
        ...
        <p>
          ...
          other than Personal Data) in any other manner that We deem appropriate
          or necessary.
        </p>
        <p>
        ...
        <p>
          ...
          for direct marketing purposes in the preceding calendar year, free of
          charge, once a year.
        </p>
        <p>
          We do not share Your Personal Data with third parties for those
          parties' direct marketing use. For more information about Our privacy
          and data collection policies, You may wish to review Our Privacy
          Policy.
        </p>
        <p>
          California residents, who are under 18 and are registered users of We,
          are allowed to request and have removed, any content or information
          that they have posted publicly. However, in cases where the law does
          not require or allow the removal of information, this may not be
          applicable. This is under California Business and Professions Code
          Section 22581.
        </p>
        <p>
          <strong>California Do Not Track Disclosure:</strong> We do not track
          the personally identifying information of Our users and visitors over
          time and across third party websites to provide targeted advertising.
          We respond to Do Not Track (DNT) signals. However, some other
          third-party websites do keep track of Your browsing activities so that
          they can tailor the information or advertising they present to You. If
          You wish to opt out of this tracking, You can enable privacy settings
          in Your browser.
        </p>
        <p>
          <a href="#tableofcontents">Back to table of contents</a>
        ...
        <p>
          ...
          of age in the USA or 16 years of age in the European Union. The
          Website is not directed to children under the age of 13 in the USA or
          16 in the European Union. We will not knowingly allow children under
          13 in the USA or 16 in the European Union to register for or become
        ...
        <p>
          ...
          deleted after the users browser is closed. You will be required to log
          in again at the next session, where you will be treated as a new user
        </p>
        <p>
          ...
          content player session cookies, load balancing session cookies and
          third party social content plug in sharing cookies
        </p>
        ...
        <p>
          ...
          cookies safely store authentication and identification information,
          for example your language selection or region.
        </p>
        ...
        <p>
          ...
          Information is collected from your browser about the types of websites
          you visit in order to offer advertisements which will most likely
          interest you. The cookies are placed by our advertisers with our
          permission.
        </p>
        ...
        <p>
          ...
          described in this Privacy Policy do not apply to information gathered
          through these other sites. We are not responsible for the actions and
          privacy policies of third parties and other sites.
        </p>
        <p>
          <a href="#tableofcontents">Back to table of contents</a>
        </p>
        ...
        <p>
          ...
          as message boards or feedback sections, becomes public and anyone may
          take and use that information. Please be careful about what You
          disclose and do not post any Personal Data that You expect to keep
          private. Please consult the applicable guidelines, if any, for use of
          Our chat rooms and other community areas for more information.
        </p>
        <p>
          <a href="#tableofcontents">Back to table of contents</a>
        </p>
        ...
        <p>
          ...
          interests on the Website, Our advertisers’ services, and elsewhere on
          the Internet, We and third parties (including service providers,
        ...
        <p>
          ...
          advertising on Your computer or laptop from some companies, including
