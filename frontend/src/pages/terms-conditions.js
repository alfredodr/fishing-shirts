    ...
    <section className={`container mx-auto my-24`}>
      <div className={`${styles.post}`}>
        ...
        <p>
          ...
          in full. Do not continue to use Fishingshirtsnow.com"s website if you
          do not accept all of the terms of service stated on this page.
        </p>
        <p>
        ...
        <h2>Cookies</h2>
        <p>
          We employ the use of cookies. By using Fishingshirtsnow.com"s website
        ...
        <p>
          ...
          You may view and/or print pages from fishingshirtsnow.com for your own
          personal use subject to restrictions set in these terms of service.
        </p>
        <p>You must not:</p>
        <ol>
          <li>Republish material from fishingshirtsnow.com</li>
          <li>Sell, rent or sub-license material from fishingshirtsnow.com</li>
          <li>
            Reproduce, duplicate or copy material from fishingshirtsnow.com
          </li>
        </ol>
        <p>
          Redistribute content from Fishingshirtsnow.com (unless content is
        ...
        <ol>
          ...
          <li>
            ...
            ("Comments") in areas of the website. Fishingshirtsnow.com does not
            ...
            Fishingshirtsnow.com, its agents or affiliates. Comments reflect the
            view and opinion of the person who posts such view or opinion. To
            the extent permitted by applicable laws Fishingshirtsnow.com shall
          ...
          <li>
            Fishingshirtsnow.com reserves the right to monitor all Comments and
          ...
          <li>
            You hereby grant to <strong>Fishingshirtsnow.com</strong> a
        ...
        <p>
          ...
          outweighs the absence of Fishingshirtsnow.com; and (d) where the link
        ...
        <p>
          ...
          e-mail to{" "}
          <a
            href="mailto:support@fishingshirtsnow.com"
            title="send an email to support@fishingshirtsnow.com"
          >
            support@fishingshirtsnow.com
          </a>
        ...
        <p>
          No use of Fishingshirtsnow.com"s logo or other artwork will be allowed
