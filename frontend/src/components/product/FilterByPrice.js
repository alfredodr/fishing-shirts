...
const FilterByPrice = ({minPrice, maxPrice, setMinPrice, setMaxPrice, min, max, step, initialMin, initialMax, priceCap}) => {
    ...
    return (
            <div className="w-1/5 border-r-1 border-textLightGray">
                {/* Filter */}
                <h2 className="mb-5">Filter by price</h2>
                {/* Slider */}
                <div className="mb-4">
                    <div className="slider relative h-1 rounded-md bg-gray-300">
                        <div className="progress absolute h-1 bg-customBlack rounded" ref={progressRef}></div>
                    </div>
