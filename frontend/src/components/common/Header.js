...
const Header = () => {
  ...
  return (
    <>  
      ...
      <header className="bg-lightBlack absolute top-0 w-full z-10">
        {/* Navbar */}
          <nav className="container mx-auto">
            ...
            <div className="container mx-auto flex items-center justify-between">
              ...
              <div className="hidden space-x-7 items-center md:flex">
                <Link href="#" className="text-lightWhite active:text-white hover:text-white ">Home</Link>
                <Link href="#" className="text-lightWhite hover:text-white">Store</Link>
                <Link href="#" className="text-lightWhite hover:text-white">Blog</Link>
                {/* Button */}
            ...
            <div className="md:hidden w-40">
              <div id="menu" className={`absolute flex flex-col items-center ${isActive === true ? null : "hidden"} py-8 space-y-6 font-bold left-6 right-6 drop-shadow-md bg-lightGray`}>
                <Link href="#">Home</Link>
